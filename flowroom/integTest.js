...
function draw(){
  ...
  // //DRAWING STUFF
  // print((frameCount-(lap*9000))+ ", " + frameCount + ", " + time);
  // if(go == true){
  //   /*
  //   // minute one
  //   if((frameCount-(lap*9000)) < 1800){
  //     background(R1, G1, B1);
  //     flow();
  //     flower(width/2, height/2, 1);
  //     fill(R1, G1, B1, 255-(frameCount-(lap*9000)));
  //     rect(0, 0, width, height);
  //       if((frameCount-(lap*9000)) > 940){
  //             newPattern();
  //       }
  //   }
  //   */
  ...
  //   /*
  //   // minute two
  //   if((frameCount-(lap*9000)) > 1800 && (frameCount-(lap*9000)) < 3600){
  //     flow();
  //     flower(width/2, height/2, 1);
  //     if((frameCount-(lap*9000)) > 2400){
  ...
  //   /*
  //   // minute three
  //   if((frameCount-(lap*9000)) > 3600 && (frameCount-(lap*9000)) < 5400){
  //     // background(R1, B1, G1);

  //     flower(width/2, height/2, 1);
  //     flow();
  //     if((frameCount-(lap*9000)) > 4000){
  //       flower(width/4, height/2, 0.5);
  //       flower(3*width/4, height/2, 0.5);
  //       if((frameCount-(lap*9000)) > 4000 && (frameCount-(lap*9000)) < 4800){
  //         newPattern();
  //       }

  //     }
  //     if((frameCount-(lap*9000)) > 4800 && (frameCount-(lap*9000)) < 5400){
  //       shrinkFlower();
  //     }
  //   }
  //   */
  ...
  //       flower(width/4, height/2, 0.5);
  //       flower(3*width/4, height/2, 0.5);
  //       if(time > 4000 && time < 4800){
  //         newPattern();
  //       }

  //     }
  //     if(time > 4800 && time < 5400){
  //       shrinkFlower();
  //     }
  //   }
  ...
  //   /*
  //   // minute four
  //   if((frameCount-(lap*9000)) > 5400 && (frameCount-(lap*9000)) < 7125){
  //    // background(R1, G1, B1); 
  //      flower(width/2, height/2, 1);
  ...
  //      flower(3*width/4, height/2, 0.4);
  //     }
  //     if((frameCount-(lap*9000)) > 6000){
  //      flower(width/2, height/2, 1);
  //      flower(3*width/8, height/2, 0.5);
  //      flower(width/2, height/2, 0.5);
  //      flower(5*width/8, height/2, 0.5);
  //     }
  //     if((frameCount-(lap*9000)) > 6300){
  //      flower(width/2, height/2, 1);
  //      flower(width/2, height/2, 0.5);
  //     }
  //     if((frameCount-(lap*9000)) > 6600){
  //      flower(width/2, height/2, 1);
  //      flower(width/2, height/2, 0.5);
  //      shrinkFlower();
  //     }
  ...
  //   if((frameCount-(lap*9000)) > 7077 && (frameCount-(lap*9000)) < 9000){
  //     background(R1, G1, B1);
  //     flow();
  //     flower(width/2, height/2, 1);
  //     if((frameCount-(lap*9000)) > 8100){
  //       shrinkFlower();
  //     }

  //     if((frameCount-(lap*9000)) > 8745){
  //       // noLoop();
  //       fill(R1, G1, B1, -8745+(frameCount-(lap*9000)));
  //       rect(0, 0, width, height);

  //     }
  //     if((frameCount-(lap*9000)) == 9000){
  //       // noLoop();
  //       // redraw();
  //       // reset fraameCount by multiples of n
  //       // lap = lap + 1;
  //       //resetSketch();
  //     }
  //   }
...
function newPattern(){
  ...
  if (animate == true){
    number = (frameCount-(lap*9000)) - 940;     
  }
