...
void loop() {
  ...
  if (switchPin < 900 && switchPin2 < 900){ //Switch is off
    fadeTowardColor( phone_slot_leds, PHONE_SLOT_NUM_LEDS, CRGB::Red, 5);
    fadeTowardColor( room_strip_leds, ROOM_STRIP_NUM_LEDS, CRGB::Black, 5);
    ...
    fadeTowardColor( phone_slot_leds, PHONE_SLOT_NUM_LEDS, CRGB::Green, 50);
    FastLED.show();
...
//    // fade all existing pixels toward bgColor by "5" (out of 255)
    fadeTowardColor( room_strip_leds, ROOM_STRIP_NUM_LEDS, targetColor, 5);
    fadeTowardColor( control_panel_leds, CONTROL_PANEL_NUM_LEDS, targetColor2, 20);
    FastLED.show();
    //FastLED.delay(10);
  }
